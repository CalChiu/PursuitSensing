    ...
    static RiggedFinger() {
      ...
      for (int i = 0; i < bones.Length; ++i) {
        if (bones[i] != null) {
          ...
          if (deformPosition) {
            var boneRootPos = GetJointPosition(i) - GetLeapHand().Arm.WristPosition.ToVector3() + startPosition;
            ...
            if (i == 3 && scaleLastFingerBone) {
              ...
              var boneTipPos = GetJointPosition(i + 1) - GetLeapHand().Arm.WristPosition.ToVector3() + startPosition;
