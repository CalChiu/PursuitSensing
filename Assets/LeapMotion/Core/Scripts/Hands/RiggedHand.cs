...
namespace Leap.Unity {
  ...
  public class RiggedHand : HandModel {
    ...
    public static void SetPosition(Vector3 pos) {
        //startPosition = GameObject.Find("Main Camera").transform.TransformPoint(pos);
        startPosition = pos;
    }
    ...
    public override void UpdateHand() {
      if (palm != null) {
        ...
        //  //palm.position = GetWristPosition() - startPosition;
        //  palm.position = startPosition;
        //}
        //else {
        //  //palm.position = GetPalmPosition() - startPosition;
        //  palm.position = startPosition;

        //  if (wristJoint) {
        //    //wristJoint.position = GetWristPosition() - startPosition;
        //    palm.position = startPosition;
        //  }
        //}
        palm.position = startPosition;
      ...
      for (int i = 0; i < fingers.Length; ++i) {
        if (fingers[i] != null) {
          ...
          fingers[i].SetStartPosition(startPosition);
